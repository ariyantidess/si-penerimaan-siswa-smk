    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-warning">
                <marquee><h4>Selamat Datang di SMK Negeri 1 Air Joman Jalan Desa Perjuangan</h4></marquee>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Penerimaan Siswa Smk Negeri 1 Air Joman</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>No Induk</th><th>Nama siswa</th><th>Tempat lahir</th><th>Alamat</th><th>jurusan</th><th>Agama</th><th>Jenis Kelamin</th>
                            </tr>
                        </thead>
                        <tbody>
